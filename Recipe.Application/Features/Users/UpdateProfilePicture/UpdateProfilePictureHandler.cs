...
{
    public class UpdateProfilePictureHandler : IRequestHandler<UpdateProfilePictureCommand, Unit>
    {
        private IUserRepository _userRepository;
        private IFileStorageService _fileStorageService;
        public UpdateProfilePictureHandler(IUserRepository userRepository, IFileStorageService fileStorageService)
        {
